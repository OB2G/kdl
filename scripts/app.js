    ...
    for (const file of files) {
        ...
        reader.onload = (e) => {
            ...
            if (type.includes('epub')) {
                // Epub.js a besoin du ArrayBuffer pour lire les métadonnées
                try {
...
function setupSwipes() {
    if (currentBookType.includes('epub')) {
        ...
        // S'assurer qu'il n'y a qu'un seul écouteur de swipe actif (pour EPUB seulement)
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const fileInput = document.getElementById('file-input-visible');
